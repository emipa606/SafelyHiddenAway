...
namespace TD.Utilities
{
    ...
    {
        public static void DrawGraph(Rect rect, string xstr, string ystr, string xfmt, string yfmt, float xMin,
            float xMax, Func<float, float> func, float? yMn = null, float? yMx = null, float roundUp = 1,
            int numDots = 50)
        {
